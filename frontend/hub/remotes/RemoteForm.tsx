...
import { PageFormExpandableSection } from '../../../framework/PageForm/PageFormeExpandableSection';
...
export function CreateRemote() {
  ...
  const onSubmit: PageFormSubmitHandler<IRemotes> = async (remote) => {
    await postRequest(pulpAPI`/remotes/ansible/collection/`, remote);
    navigate(-1);
  };
          ...
          <PageFormSection singleColumn>
            <PageFormExpandableSection>
              <PageFormSection>
                ...
                <CeriticatesAdvancedRemoteInputs />
...
function CeriticatesAdvancedRemoteInputs() {
  const { t } = useTranslation();
  return (
    <>
      <PageFormGroup
