    ...
    (rulebookActivations: EdaRulebookActivation[]) => {
      bulkAction({
        ...
        actionFn: (rulebookActivation: EdaRulebookActivation) =>
          postRequest(`${EDA_API_PREFIX}/activations/${rulebookActivation.id}/enable/`, undefined),
      });
    },
  ...
  return useCallback(
    (rulebookActivations: EdaRulebookActivation[]) => {
      bulkAction({
        ...
        onComplete,
        actionFn: (rulebookActivation: EdaRulebookActivation) =>
          postRequest(`${EDA_API_PREFIX}/activations/${rulebookActivation.id}/disable/`, undefined),
      });
    },
    [actionColumns, bulkAction, confirmationColumns, postRequest, onComplete, t]
  );
  ...
  return useCallback(
    (rulebookActivations: EdaRulebookActivation[]) => {
      bulkAction({
        ...
        onComplete,
        actionFn: (rulebookActivation: EdaRulebookActivation) =>
          postRequest(`${EDA_API_PREFIX}/activations/${rulebookActivation.id}/restart/`, undefined),
      });
    },
    [actionColumns, bulkAction, confirmationColumns, postRequest, onComplete, t]
  );
